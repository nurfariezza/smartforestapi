...
def validate_penandaan_semp_form(hutansimpan_id, kompatmen,pokokstesen, spesies, koordinate_x,koordinate_y):
    if not (hutansimpan_id and kompatmen  and pokokstesen and spesies and koordinate_x and koordinate_y):
        return {
            ...
            'koordinate_x': 'Coordinate Y is required',
            'koordinate_y': 'Coordinate Y  is required',
...
def validate_bancian_selepas_tebangan(kompatment_id,no_pokok,no_tag,dbh,spesies,pepanjat,bil_tual):

    if not (kompatment_id and no_pokok and no_tag and dbh and spesies and pepanjat and bil_tual):
        return {
            'kompatment_id': 'Kompatmen ID is required',
            'no_pokok': 'Pokok ID is required',
...
def validate_penandaanpokok(kompatmen_id,no_pokok,no_tag,spesies_id,dbh,koordinate_x,koordinate_y,bil_tual):

    if not (kompatmen_id and no_pokok and no_tag and spesies_id and dbh and koordinate_x and koordinate_y and bil_tual ):
        return {
            ...
            'dbh': 'DBH is required',
            'koordinate_x': 'Koordinate X is required',
            'koordinate_y': 'Koordinate Y is required',            
            'bil_tual': 'Bil Tual is required',
...
def validate_update_penandaanpokok(kompatmen_id,no_pokok,spesies_id,dbh,koordinate_x,koordinate_y,bil_tual):

    if not (kompatmen_id and no_pokok and spesies_id and dbh and koordinate_x and koordinate_y and bil_tual ):
        return {
            'kompatmen_id': 'Kompatmen ID is required',
            'no_pokok': 'Pokok ID is required',
            'spesies_id': 'Spesis is required',
